...
function LoginForm() {
  ...
  return (
<div className="h-screen flex mt-5 justify-center items-center ">
       <form
  onSubmit={handleOnSubmit}
  className="mt-6 flex w-[50%]   max-w-4xl h-fit  p-6 sm:p-10 bg-gray-900 rounded-lg shadow-lg  flex-col gap-4"
>
  {/* Email */}
  ...
  <label className="relative w-full">
    ...
    <input
      ...
      className="w-full rounded-md bg-gray-800 p-3 pr-12 text-white outline-none focus:ring-2 focus:ring-yellow-400"
    />
    {/* Toggle Eye Icon */}
    <span

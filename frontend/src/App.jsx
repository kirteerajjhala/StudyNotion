...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 flex ov flex-col font-sans text-white">
      <Navbar />

      {/* Scroll to top button */}
      <button
        onClick={() => window.scrollTo(0, 0)}
        className={`fixed right-4 z-10 p-3 text-lg rounded-full bg-yellow-400 text-black shadow-md hover:bg-yellow-300 hover:scale-110 duration-500 ease-in-out ${

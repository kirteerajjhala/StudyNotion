...
exports.editCourse = async (req, res) => {
  try {
    // If request is FormData (with files), body will be in req.body
    // If request is JSON, req.body is already JSON
    const updates = { ...req.body }; // make a shallow copy
    ...
    for (const key in updates) {
      if (Object.prototype.hasOwnProperty.call(updates, key)) {
        if (key === "courseId") continue; // skip courseId

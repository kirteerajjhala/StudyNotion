...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="text-3xl lg:text-4xl text-wrap  px-10 md:px-0 font-semibold text-center my-10">
          Unlock the
          ...
          return (
            <div
              className={` text-[16px] flex flex-row items-center gap-2 ${currentTab === ele
                ...
                : "text-richblack-200"
                } px-7 py-[7px] rounded-full transition-all duration-200 cursor-pointer hover:bg-[#000814] hover:text-white`}
              key={index}

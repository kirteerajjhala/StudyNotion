...
function SignupForm() {
  ...
  return (
 <div className="w-full h-screen mt-5 flex px-5 justify-center items-center ">
       <div className="lg:w-[50%] w-full  max-w-4xl h-[80%] p-6 sm:p-10 bg-gray-900 rounded-lg shadow-lg">
  {/* Tab */}
  <Tab tabData={tabData} field={accountType} setField={setAccountType} />

  {/* Form */}
  <form onSubmit={handleOnSubmit} className="flex flex-col gap-6 h-[50%]">
    {/* Name Fields */}
